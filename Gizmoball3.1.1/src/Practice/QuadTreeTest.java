...
public class QuadTreeTest {
	...
	public static void main(String[] args) {
		...
		gizmos = new Quadtree<gizmosInterface>(new Rectangle(0,0,320,320));
		...
		//TestCase #7: retrieve function
		System.out.println("TestCase #7: retrieve function");
		gizmos = new Quadtree<gizmosInterface>(new Rectangle(0,0,640,640));
		...
		//System.out.println(gizmos.toString());
		Rectangle ball = new Rectangle(0,0,16,16);
		ArrayList<gizmosInterface> retrieve = new ArrayList<gizmosInterface>();
		retrieve = gizmos.retrieve(retrieve, ball);
		for(gizmosInterface gizmo:retrieve){
			System.out.print(gizmo.toString());
		}

		
		ball = new Rectangle(0,0,16,16);
