...
public class Configuration {
	...
	public final static int SCALE = 4;											//window size scale factor
	 ...
	 * */
	private Quadtree<gizmosInterface> gizmos;
	private ArrayList<gizmosInterface> allGizmos;
	//Constructor
	public Configuration(){
		gizmos =new Quadtree<gizmosInterface>(new Rectangle(0,0,WIDTH*SCALE,WIDTH*SCALE));
	...
	public String toString(){
		String output = null;
		System.out.println();
		allGizmos = this.gizmos.returnAll(allGizmos);
		...
		for(int i=0;i<allGizmos.size();i++){
			output+=allGizmos.get(i).toString();
		}
