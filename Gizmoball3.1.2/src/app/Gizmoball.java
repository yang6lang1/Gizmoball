...
public class Gizmoball extends JFrame{	
	...
	public Gizmoball() {
		...
		panel.setBounds((width/4)*scale, 0, width*scale, height*scale);
	...
	protected void addButtonsToGameToolBar(JToolBar toolBar,JPanel panelOne,JPanel panelTwo){
		...
		gameButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(panel.isSelected()){
					panel.getBuffer().select();
					panel.setSelected(false);
					panel.selectGizmo(null);
				}
				setMode(GAME_MODE);
	...
	protected void addButtonsToBuildToolBar(JToolBar toolBar,JPanel panelOne,JPanel panelTwo){
		...
		squareBumperButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel.addGizmos(new squareBumper(0,0));
				panel.repaint();
				panel.requestFocusInWindow();
		...
		triangularBumperButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel.addGizmos(new triangleBumper());
				panel.repaint();  
				panel.requestFocusInWindow();
				panel.setIsDirty(true);
			}
		...
		circularBumperButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panel.addGizmos(new circleBumper());
				panel.repaint();    
				panel.requestFocusInWindow();
				panel.setIsDirty(true);
			}
		...
		rotateButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(panel.getBuffer()!= null){

					Rectangle rotateArea = panel.getBuffer().boundingBox();
					panel.getBuffer().rotate();
					panel.repaint(rotateArea.x,rotateArea.y,rotateArea.width,rotateArea.height);
					panel.requestFocusInWindow();
					panel.setIsDirty(true);
				}
			}
		...
		deleteButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(panel.getBuffer()!= null){
					panel.deleteGizmos(panel.getBuffer());
					panel.repaint();
					panel.requestFocusInWindow();
					panel.setIsDirty(true);
				}
	...
	protected void setMode(boolean mode){
		...
		if(mode == GAME_MODE){
			...
			animationWindow.setGizmos(panel.getGizmos());
